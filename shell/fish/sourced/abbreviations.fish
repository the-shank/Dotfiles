...
abbr -a db-bss-stop "cd ~/code/dct/dct-dev-helpers; and docker-compose down; and cd -"
abbr -a db-tp-start "cd ~/code/dct/dct-dev-helpers; and docker-compose up --detach tp-db; and cd -"
abbr -a db-tp-stop "cd ~/code/dct/dct-dev-helpers; and docker-compose down; and cd -"
